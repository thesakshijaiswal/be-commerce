...
const ProductCardShimmer = () => {
  return (
    <div className="h-96 w-80 space-y-4 rounded-xl bg-white p-4 text-black duration-300 hover:scale-105">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="h-7 w-32 rounded-md bg-slate-200 px-8 py-4"></div>
      </div>
    </div>
  );
};
