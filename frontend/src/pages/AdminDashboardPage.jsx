...
const AdminDashboardPage = () => {
  ...
  return (
    <div className="mx-auto p-3 sm:p-6">
      <div className="relative flex border-b border-gray-200">
        {tabs.map((tab) => (
          <button
            ...
            className={`select-none border-b-2 px-4 py-2 font-medium transition-all duration-300 ${
              currentTab === tab.name
      ...
      <div className="mt-6 min-h-screen rounded-lg bg-white p-3 shadow-md sm:p-6">
        <Outlet />
      </div>
    </div>
  );
